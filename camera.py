...
music_dist={0:"songs/angry.csv",1:"songs/disgusted.csv ",2:"songs/Disappoint.csv",3:"songs/happy.csv",4:"songs/neutral.csv",5:"songs/sad.csv"}
global last_frame1                                    
